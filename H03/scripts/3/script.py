...
classifier1 = MLPRegressor(alpha = 20, activation = "relu", hidden_layer_sizes=(3, 2), early_stopping = False,  random_state= 13, max_iter = 1500)
classifier2 = MLPRegressor(alpha = 1e-5, activation = "relu", hidden_layer_sizes=(3, 2), early_stopping = False,  random_state= 13, max_iter = 1500)
...
residuals = {"With Regularization": residuals1, "Without Regularization": residuals2}

fig, ax = plt.subplots()
ax.boxplot(residuals.values())
ax.set_xticklabels(residuals.keys())
